...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
	...
	company_currency = "BHD" #frappe.get_cached_value('Company',  filters.get('company'),  'default_currency')
	...
	for d in item_list:
		...
		#supplier_row = len(item_doc.item_defaults)
		#frappe.throw(f"{str(item_doc.item_defaults)}")
		
		#if supplier_row:
		#	for item_default in item_record.item_defaults:
		#		frappe.msgprint(item_default.default_supplier)
