...
def get_data():
    ...
    return [
        ...
        make_section('Reports', [
            ...
            make_item('report', 'Customer Item-wise Sales', 'Customer Item-wise Sales', True),
            make_item('report', 'Customer Sales Summary', 'Customer Sales Summary', True),
            make_item('report', 'Item-wise Periodic Sales for Customer', 'Item-wise Periodic Sales for Customer', True),
            make_item('report', 'Item-wise Sales Returns', 'Item-wise Sales Returns', True),
            make_item('report', 'Simple Sales Register', 'Simple Sales Register', True),
            make_item('report', 'Simple Purchase Register', 'Simple Purchase Register', True),
            make_item('report', 'Sales Person Item-wise Sales', 'Sales Person Item-wise Sales', True),
            make_item('report', 'Daily Sales Summary', 'Daily Sales Summary', True),
            make_item('report', 'Item Balance (Simple) with Supplier', 'Item Balance (Simple) with Supplier', True),
            make_item('report', 'Stock Ledger (Simple)', 'Stock Ledger (Simple)', True),
            make_item('report', 'Daily Cash', 'Daily Cash', True),
            make_item('report', 'Item-wise Sales Register Simple', 'Item-wise Sales Register Simple', True),
            make_item('report', 'Cheque Summary', 'Cheque Summary', True),
            make_item('report', 'Cash Account', 'Cash Account', True),
            make_item('report', 'Daily Item-wise Sales', 'Daily Item-wise Sales', True),
            make_item('report', 'Daily Cash with Payment', 'Daily Cash with Payment', True),
            make_item('report', 'Stock Balance with Prices', 'Stock Balance with Prices', True),
            make_item('report', 'Sales and Purchase History', 'Sales and Purchase History', True),
            make_item('report', 'Item-wise Purchase Register Simple', 'Item-wise Purchase Register Simple', True),
            make_item('report', 'Accounts Payable 2', 'Accounts Payable 2', True),
            make_item('report', 'Accounts Receivable 2', 'Accounts Receivable 2', True),
            make_item('report', 'Sales Register with Employee', 'Sales Register with Employee', True),
        ...
        make_section('Documents', [
            ...
            make_item('doctype', 'Backported Stock Reconciliation', 'Backported Stock Reconciliation'),
